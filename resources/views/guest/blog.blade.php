...
<head>
    <meta charset="UTF-8">
    <meta name="description" content="Blog - Male Fashion">
    <meta name="keywords" content="Male_Fashion, blog, fashion, trends">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Fashion Blog | Male Fashion</title>
                ...
                <div class="col-lg-6 col-md-6">
                    <nav class="header__menu mobile-menu">
                        <ul>
                            ...
                            <li><a href="{{ route('guest.blog') }}" class="active">Blog</a></li>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{ asset('img/malefashion-img/blog/blog-1.jpg') }}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('img/malefashion-img/icon/calendar.png') }}" alt=""> 16 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{ asset('img/malefashion-img/blog/blog-2.jpg') }}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('img/malefashion-img/icon/calendar.png') }}" alt=""> 21 February 2020</span>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{ asset('img/malefashion-img/blog/blog-3.jpg') }}"></div>
                        <div class="blog__item__text">
                            <span><img src="{{ asset('img/malefashion-img/icon/calendar.png') }}" alt=""> 28 February 2020</span>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-7">
                    <div class="footer__about">
                        ...
                        <p>Premium fashion store offering the latest trends and timeless classics.</p>
                    </div>
                </div>
            </div>
        </div>
